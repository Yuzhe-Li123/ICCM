...
def ORL():
    ...
    from sklearn import preprocessing
    min_max_scaler = preprocessing.MinMaxScaler()
    data = scio.loadmat(path + "/ORL.mat")
    x1 = data['X1']
    x2 = data['X2']
    x1 = min_max_scaler.fit_transform(x1)
    x2 = min_max_scaler.fit_transform(x2)
...
def LandUse():
    ...
    from sklearn import preprocessing
    min_max_scaler = preprocessing.MinMaxScaler()
    data = scio.loadmat(path + "/LandUse.mat")
    x1 = data['X1']
    x2 = data['X2']
    x1 = min_max_scaler.fit_transform(x1)
    x2 = min_max_scaler.fit_transform(x2)
...
def Scene():
    ...
    from sklearn import preprocessing
    min_max_scaler = preprocessing.MinMaxScaler()
    data = scio.loadmat(path + "/Scene.mat")
    x1 = data['X1']
    x2 = data['X2']
    x1 = min_max_scaler.fit_transform(x1)
    x2 = min_max_scaler.fit_transform(x2)
...
def Scene_15():
    ...
    from sklearn import preprocessing
    min_max_scaler = preprocessing.MinMaxScaler()
    data = scio.loadmat(path + "/Scene_15.mat")
    x1 = data['X1']
    x2 = data['X2']
    x3 = data['X3']
    x1 = min_max_scaler.fit_transform(x1)
...
def NoisyMINIST():
    ...
    from sklearn import preprocessing
    min_max_scaler = preprocessing.MinMaxScaler()
    data = scio.loadmat(path + "/NoisyMINIST.mat")
    x1 = data['X1']
    x2 = data['X2']
    x1 = min_max_scaler.fit_transform(x1)
    x2 = min_max_scaler.fit_transform(x2)
...
def load_data_conv(dataset):
    ...
    if dataset == 'HW':               # HW
        ...
        return ALOI()
    elif dataset == 'ORL':                   # Fashion-10K-3views
        return ORL()
    elif dataset == 'Scene':
        return Scene()
